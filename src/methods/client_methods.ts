...
//--------------------------------------- UPDATE ---------------------------------------------
export async function updateClientName(CPF: string, new_first_name: string, new_last_name: string, client_table: Repository<Client>): Promise<void>{
...
export async function updateClientBirthdate(CPF:string, date: string, client_table: Repository<Client>): Promise<void> {
  if(isCPFValid(CPF)){
